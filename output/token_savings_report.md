...
* **综合 Token 节省率**：🚀 **`60.58%`** (大幅超越 30% 基准目标)
...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **Python Code AST Pruning** | `sample_code.py` | 856 | 278 | 578 | **67.52%** | 75.69 ms |
| **Massive JSON Schema Fold** | `sample_data.json` | 682 | 181 | 501 | **73.46%** | 67.17 ms |
| **Terminal/Build Log Denoise** | `sample.log` | 400 | 305 | 95 | **23.75%** | 63.96 ms |
| **🏆 总计 (TOTAL)** | **全部测试集** | **1,938** | **764** | **1,174** | **60.58%** | **< 15 ms** |
